 ...
 */
 module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    html2js: {
      /**
       * These are the templates from `front-office/app`.
       */
      app: {
        options: {
          base: 'front-office/app'
        },
        src: [ '<%= app_files.atpl %>' ],
      ...
      /**
       * These are the templates from `front-office/common`.
       */
      common: {
        options: {
          base: 'front-office/common'
        },
        src: [ '<%= app_files.ctpl %>' ],
  ...
  grunt.registerMultiTask( 'index', 'Process index.html template', function () {
    ...
    grunt.file.copy('front-office/index.html', this.data.dir + '/index.html', { 
